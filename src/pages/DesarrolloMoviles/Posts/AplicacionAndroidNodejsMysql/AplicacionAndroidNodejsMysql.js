      ...
      <div className="all-pages">
        ...
        <div className="the-page">
          ...
          <div className="container my-5 px-5">
            ...
            <div className="p-3 bg-info mt-5">
              <h6>Nota</h6>
            ...
            <p>
              ...
              trabajando con la versión <b>16.17.0.</b> El servidor se desarrollará empleando el framework
              de  <i>Express</i> y la librería de mysql para
            ...
            <p>
              Para instalar express ejecutamos:
            </p>
            ...
            <div>
              ...
              <p>
                ...
                agregar un nuevo par llave-valor que sea:
              </p>
            </div>
            ...
            <p>
              ...
              instrucciones en un archivo <i>.sql</i> que se guardará en la carpeta de <i>backend</i>.
            </p>
            ...
            <p>
              ...
              las siguientes instrucciones dentro de la shell de MySQL:
            </p>
            ...
            <p>
              Luego de ello creamos un método al que denominaremos <code>iniciarSesion</code> que contedrá lo siguiente:
            </p>
            ...
            <p>
              ...
              Para ello, basta con dirigirse a la consola de comandos y digitar <code>ipconfig (para Windows y MAC) e ifconfig (para Linux). </code>
              Luego de esto, tenemos que dirigirnos al <code>activity main</code> del proyecto y agregar el método
              <code> onClick</code> al botón de <code>iniciar sesión.</code> Hecho esto, nuestro botón de iniciar sesión
            ...
            <div className="bg-warning p-3 my-3">
              <h6>Atención</h6>
            ...
            <p>
              ...
              Cualquier duda, queja, recomendación o donación que deseen realizar me pueden contactar por telegram: <a href="https://t.me/Juan0_1" target="_blank">https://t.me/Juan0_1</a>.
